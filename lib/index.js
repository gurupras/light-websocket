...
function onSocketMessage (msg) {
  ...
  let packet
  try {
    packet = Json.bytesToMessage(msg.data)
  } catch (e) {
...
class LightWebSocket {
  ...
  emit (event, data) {
    ...
    const bytes = Json.messageToBytes(packet)
...
LightWebSocket.messageToBytes = Json.messageToBytes
LightWebSocket.bytesToMessage = Json.bytesToMessage
